...
<div class="main-content-wrapper d-flex clearfix">
    ...
    <header class="header-area clearfix">
        ...
        <div class="amado-btn-group mt-30 mb-100">
            @if (Route::has('login'))
                @if (!Auth::check())
                    <a href="/login" class="btn amado-btn mb-15">Вход/Регистрация</a>
                @else <a href="/home" class="btn amado-btn mb-15">Личный кабинет</a>
                @endif
            @endif
            <a href="" class="btn amado-btn">% Скидки %</a>
        </div>
        <!-- Cart Menu -->
